...
import car from "/src/Components/images/carto.jpeg"
            ...
            <section id="hero">
                <div className="container flex flex-col-reverse md:flex-row items-center  px-6 mx-auto mt-10 space-x-0 md:space-y-0">
                    ...
                    <div className="lg:px-16">
                        <h2 className="mb-4 max-w-md text-3xl font-bold text-center md:text-left lg:mt-24">Plan your trip with ZoomZest</h2>
