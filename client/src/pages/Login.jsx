...
export default function Login() {
    ...
    const Submit = (event) => {
        ...
        // Simulating a login process without a backend
        const mockEmail = 'test@example.com'; // Replace with a mock email
        const mockPassword = 'password123'; // Replace with a mock password
        ...
        if (email === mockEmail && password === mockPassword) {
            ...
            setUser(mockUserData); // Setting mock user data
            navigate('/account');
        } else {
            setCheckUser(true);
            setTimeout(() => {
